...
/**
 * Create the given {@link module:features/user/featureTable~FeatureTable}
 * @param  {FeatureView}   featureView    feature view
 */
GeoPackage.prototype.createFeatureView = function(featureView) {
  return this.tableCreator.createUserView(featureView);
};
